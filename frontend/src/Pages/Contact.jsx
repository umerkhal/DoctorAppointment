...
const Contact = () => {
  return (
    <div>
      ...
      <div className='flex flex-col my-10 md:flex-row mb-28 text-sm justify-center gap-10 '>
        <img className='w-full md:max-w-[360px]' src={assets.contact_image} alt="" />
        <div className='flex flex-col justify-center items-start gap-6'>
          <p className='text-lg font-semibold text-gray-600'>Our OFFICE</p>
          <p className='text-gray-500 '>54709 Willms Station <br /> Suite 350, Washington, USA</p>
          <p className='text-gray-500 '>Tel: 03098842500 <br />umerkhalidvajad321@gmail.com</p>
